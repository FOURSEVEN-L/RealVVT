...
# todo
_UNetSpatioTemporalCondition_available = True
try:
...
def is_UNetSpatioTemporalCondition_available():
    return _UNetSpatioTemporalCondition_available
...
"""
UNETSTC_IMPORT_ERROR = """
{0} requires the UNetSpatioTemporalConditionModel library but it was not found in your environment. You can install it with pip: `pip install peft`
"""
...
BACKENDS_MAPPING = OrderedDict(
    [
        ...
        ("UNetSpatioTemporalCondition", (is_UNetSpatioTemporalCondition_available, UNETSTC_IMPORT_ERROR)),
